...
<script type="text/javascript">
	...
	$(function() {
		var settings = {
   			...
   			upload_url: "<app:contextPath/>/lbTPersonCreditReport/uploadPersonCreditReport;jsessionid=<%=request.getSession().getId()%>",	
   			use_query_string : true,
   			file_size_limit : "100 MB",
   			file_types : "*.zip;",
   			file_types_description : "请选择zip文件上传",
   			file_upload_limit : 2,
   			file_queue_limit : 0,
   			custom_settings : {
...
<div id="content">
    <div class="tipCls">
		<div></div>
		<div class="tpCls"><span >请选择zip文件上传</span></div>
	</div>
	<div class="uploadCls">
