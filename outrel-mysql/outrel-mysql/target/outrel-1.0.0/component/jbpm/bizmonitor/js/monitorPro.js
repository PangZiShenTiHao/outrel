 ...
 * 设置 查询条件的 流程创建的开始时间 
 */
function setProStartEndDate(){
	var _staTime = $("[name='protime_start']").val();
	$("[name='proStartTime']").val(_staTime);
	var _endTime = $("[name='protime_end']").val();
	$("[name='proEndTime']").val(_endTime);
}
