...
<html xmlns="http://www.w3.org/1999/xhtml" >
  ...
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script src="${basePath1}component/jbpm/aftloan/js/monitorPro.js"></script>
</head>
	...
	function initFn(){
		...
		//定义 form表单查询 信息
		 var formStructure={
	        ...
	        ,{display : '业务类型', code : 'bizType', width : 200,  type:'select',value:<syscode:dictionary codeType="WORKFLOW_BIZ_TYPE" type="json" used="1004,1010,1009,1011,1013,1014" hasBlank="false"/>}
