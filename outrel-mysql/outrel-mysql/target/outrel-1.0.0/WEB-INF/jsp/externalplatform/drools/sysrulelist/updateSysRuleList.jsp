...
<div id="formPageSwap">
  <br/>
<form id="updateNewsFormData" name="updateNewsFormData" isCheck="true" action="com.jy.modules.externalplatform.drools.sysrulelist.controller.SysRuleListController">
...
<tr>
  <th> 中文名 ：</th>
  <td > 
  <input id="dtochName" name="chName" notNull="false" maxLength="100" value="${dto.chName}" />
  </td>
  <th> 英文名：</th>
  <td > 
  <input id="dtoenName" name="enName" notNull="false" maxLength="100" value="${dto.enName}" readonly="readonly"/><span style="color:#FF0000;font-weight:bold;">*不允许修改</span>
  </td>
  </tr>
  <c:choose>
...
<tr>
  <th> 描述 ：</th>
  <td colspan=3>
   <textarea id="dtoremark" name="remark" notNull="false"  style="width:80%;height:50px;">${dto.remark}</textarea>
  </td>
</tr>
<tr>
