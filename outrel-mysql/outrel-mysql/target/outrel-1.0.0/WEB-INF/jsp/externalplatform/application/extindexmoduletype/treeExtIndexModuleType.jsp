...
<html><head>
	...
	<script type="text/javascript" src="${basePath}/js/externalplatform/application/extindexmoduletype/queryExtIndexModuleType.js?d=<%=myDate%>"></script>
    <title>模块类型树形</title>
...
jQuery(document).ready(function($) {
    var treeStr={"disabledLink":false,"isEdit":true,"check":false,"checkChildNodes":false,"url":contextRootPath+'/extIndexModuleType/queryTreeExtIndexModuleType',"addFun":addFun,"editFun":editFun,"removeFun":removeFun,"viewFun":viewFun};
