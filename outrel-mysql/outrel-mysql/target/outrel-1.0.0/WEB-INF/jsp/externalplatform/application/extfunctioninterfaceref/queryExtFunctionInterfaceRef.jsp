...
<head>
  ...
  <title>查询功能接口映射表</title>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
</head>
<body style="background-color:#FFFFFF">
<!-- 列表按钮操作 start -->
	<div id="tableToolbar" class="tableToolbar" style="display:none;">
		  	<a href="javascript:void(0)" onclick="toAddData('1')" index="0">新增</a>
...
<script>
	...
	function initFn(){
		...
		var tableStructure = {
			...
			,{display : ' 接口名称 ', code : 'interfaceName', width : 180, align : 'center', type:'text', isOrder : false}
			,{display : ' 接口编码 ', code : 'interfaceNo', width : 180, align : 'left', type:'hidden', isOrder : false}
			,{display : '接口调用优先级', code : 'priority', width : 100, align : 'center', type:'text', isOrder : false}
			...
			url : "${basePath}extFunctionInterfaceRef/queryListExtFunctionInterfaceRef?confType=1",
