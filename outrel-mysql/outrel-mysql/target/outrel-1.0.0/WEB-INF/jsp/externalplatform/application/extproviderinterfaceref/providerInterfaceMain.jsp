...
<body style="background-color:#FFFFFF">
	...
	<div class="leftPanel">
		<div class="titleSwap">
			<label class="innerTitle">提供商信息</label>
		</div>
		<div class="contentSwap">
			<div class="innerPanel" id="innerPanel">
				<div class="ztree" id="RoleList">
					<iframe src='${basePath}extProviderInfo/prepareExecute/toQueryPage'
	...
	<div class="contentPanel">
		<div class="titleSwap">
			<label class="innerTitle">提供商对应接口信息</label>
		</div>
		<div class="contentSwap" id="contentSwap">
			<iframe src='${basePath}extProviderInterfaceRef/prepareExecute/toQueryPage?providerCode=-1'
