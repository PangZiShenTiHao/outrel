 ...
 * @time: 17:33
 **/
@Component("com.jy.modules.biz.bizasynjob.SimpleRecoveryJobB")
public class SimpleRecoveryJobB implements Serializable,Job{
    private static final long serialVersionUID = -3478113883527400626L;
    private static final Logger logger = LoggerFactory.getLogger(SimpleRecoveryJobB.class);
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
	        ...
	        logger.info("JOB 222222222222222 SimpleRecoveryJobA says: " + jobName + " executing at ");
