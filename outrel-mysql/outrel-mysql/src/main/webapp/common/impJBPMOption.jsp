...
<div class="expandSwap">
	<div class="expandTitle"  align="left">
	...
	<tr>
	  <th> 意见信息：</th>
	  <td> <textarea rows="5" cols="85" id="optionRemarkId" name="optionRemark" maxlength="1000"></textarea></td>
	</tr>
	<tr>
		<td  colspan="2">
			<!-- 工作流按钮start -->
	...
	<div style="display:none;">
		<table>
			...
			<tr>
				<th>流程参数信息 ：</th>
			  	<td colspan="5">
				<textarea class="validate[maxSize[500]] input_hui"  id="dtootherParamJavaCode" name="otherParamJavaCode" rows="5" cols="120" title='' >
				java.util.Map map = new java.util.HashMap(); map.put("owner","partnerUserId");map.put("result", "to");map.put("proTaskId", "${taskId}");
					map.put("proProcessInsId", "${processInsId}");map.put("proAcitityName", "${acitityName}");map.put("proBizTabId", "${bizTabId}");
					map.put("proBizTabName", "${bizTabName}");map.put("proBizInfId", "${bizInfId}");return map;
				</textarea>
			   	</td>
			</tr>
		</table>
	...
	<div style="width: 100%;" align="center">
		<iframe id="bizOptionIframeId" name="bizOptionIframeName" src="${basePath}/component/jbpm/bizOption/queryBizOption.jsp?bizTabId=${bizTabId}&bizInfId=${bizInfId}&bizType={bizType}" width="100%" width="100%" frameborder="no"></iframe>
	</div> 
	<!-- 意见列表end -->
