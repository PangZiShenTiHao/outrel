...
<head>
   ...
   <script type="text/javascript" src="${basePath}/js/externalplatform/drools/sysrulelist/querySysRuleList.js"></script>
  <title>业务规则管理</title>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
	    var treeStr={"disabledLink":false,"isEdit":true,"check":false,"checkChildNodes":false,"url":contextRootPath+"/sysRuleList/queryListSysRuleList","addFun":addFun,"editFun":editFun,"removeFun":removeFun,"viewFun":viewFun};
