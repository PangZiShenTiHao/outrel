	...
	function initFn(){
		//定义 form表单查询 信息
		 var formStructure={
			...
			,{display : ' 机构 ', code : 'reqOrgCode2', width : 200,  type:'autocomplete'}
			,{display : ' 机构 ', code : 'reqOrgCode', width : 200,  type:'hidden', value:''}			
	        ,{display : ' 产品 ', code : 'reqProCode', width : 200,  type:'autocomplete'}
	        ,{display : ' 证件号码 ', code : 'reqCardId',width : 200,  type:'text', value:''}	
		...
		var tableStructure = {
			...
			,{display : ' 返回码描述', code : 'retCode', width : 100, align : 'left', type:'select', value:<syscode:dictionary codeType="RET_CODE" type="json"></syscode:dictionary>, isOrder : false}
			,{display : ' 返回信息 ', code : 'retMsg', width : 150, align : 'left', type:'text', isOrder : false}
			,{display : ' 返回时间 ', code : 'retTime', width : 120, align : 'left', type:'date', format:'yyyy-MM-dd hh:mm:ss', isOrder : false}
			],
			url : "${basePath}extInterfaceLog/queryListExtInterfaceLog?parentId=0",
