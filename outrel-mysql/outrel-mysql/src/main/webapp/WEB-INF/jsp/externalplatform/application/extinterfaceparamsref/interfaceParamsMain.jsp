...
<body style="background-color:#FFFFFF">
	...
	<div class="leftPanel">
		<div class="titleSwap">
			<label class="innerTitle">接口信息</label>
		</div>
		<div class="contentSwap">
			<div class="innerPanel" id="innerPanel">
				<div class="ztree" id="RoleList">
					<iframe src='${basePath}extInterfaceInfo/prepareExecute/toQueryPage'
	...
	<div class="contentPanel">
		<div class="titleSwap">
			<label class="innerTitle">接口参数信息</label>
		</div>
		<div class="contentSwap" id="contentSwap">
			<iframe src='${basePath}extInterfaceParamsRef/prepareExecute/toQueryPage?interfaceNo=-1'
