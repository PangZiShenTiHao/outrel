...
<html><head>
	...
	<script type="text/javascript" src="${basePath}/js/externalplatform/drools/sysrulelist/treeSelectModelAttr.js"></script>
...
<div class="leftPanel">
    <div class="titleSwap"><label class="innerTitle">业务模型${modelFlag}</label></div>
