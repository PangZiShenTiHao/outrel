...
<head>
  ...
  <title>查询外联平台系统管理表</title>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <script type="text/javascript" src="${basePath}/js/externalplatform/application/extsysmanagement/queryExtSysManagement.js"></script>
<!-- 相关js方法 -->
	...
	function initFn(){
		//定义 form表单查询 信息
		 var formStructure={
			// 定义form表单 字段信息
			columns : [
			 {display : ' 系统编号 ', code : 'sysCode', width : 200,  type:'text'}
	        ,{display : ' 系统名称 ', code : 'sysName', width : 200,  type:'text'}
		...
		var tableStructure = {
			//定义table 列表的表头信息
			columns : [
			 {display : ' 系统编号 ', code : 'sysCode', width : 100, align : 'left', type:'fun', isOrder : false,
			  value:function (obj){
						return "<a href='javascript:void(0)' onclick='viewData("+obj.id+")'>"+obj.sysCode+"</a>";
				    }	 
			 }
			...
			url : "${basePath}extSysManagement/queryListExtSysManagement",
