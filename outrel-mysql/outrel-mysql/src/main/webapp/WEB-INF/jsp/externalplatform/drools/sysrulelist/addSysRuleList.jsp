...
<div id="formPageSwap">
  <br/>
<form id="addNewsFormData" name="addNewsFormData" isCheck="true" action="com.jy.modules.externalplatform.drools.sysrulelist.controller.SysRuleListController">
...
<tr>
  ...
  <th> 中文名 ：</th>
  <td > 
  <input class="text" id="dtochName" name="chName" notNull="false" maxLength="100" value="" />
  </td>
  </tr>
  <tr id='hiddenTr'>
  <th> 英文名：</th>
  <td> 
  <input class="text" id="dtoenName" name="enName" notNull="false" maxLength="100" value=""  onblur="checkUnique(this,'&enName='+$(this).val());"/>
  </td>
...
<tr>
	<th> 描述 ：</th>
  <td colspan=5>
  <textarea id="dtoremark" name="remark" notNull="false"  style="width:80%;height:50px;"></textarea>
  </td>
 </tr>
  </table>
  <br/>
