	...
	function initFn(){
		...
		//定义 form表单查询 信息
		 var formStructure={
	        ...
	        ,{display : '流程发起时间', code : 'time', width : 100, align : 'left',type: 'dbDateTime',isCompare:true}
	        ,{display : '开始', code : 'startTime', width : 200,  type:'hidden'}
	        ,{display : '结束', code : 'endTime', width : 200,  type:'hidden'}
	        ,{display : '流程结束时间', code : 'jbpmEndTime', width : 100, align : 'left',type: 'dbDateTime',isCompare:true}
		...
		var tableStructure = {
				...
				{display : '业务发起者', code : 'START_PRO_USERNAME', width : 100, align : 'center', type:'text'},
				...
				<c:if test="${!fn:contains(monitorHiddenColumn,'#CUR_EXE_ID#') }">
				{display : '流程实例', code : 'PRO_INSTANCE_ID', width : 200, align : 'center', type:'text'},
				</c:if>
				{display : '流程发起时间', code : 'CREATE_TIME', width : 120, align : 'center', type:'text', isOrder : true},
				{display : '流程结束时间', code : 'PRO_END_TIME', width : 120, align : 'center', type:'text', isOrder : true},
