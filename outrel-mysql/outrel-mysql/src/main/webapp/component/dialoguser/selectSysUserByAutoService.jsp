...
function initFn (){
	//定义 form表单查询 信息
	 var formStructure={
        ...
        ,{display : '机构/部门', code : 'orgId', width : 200,  type:'select', value:<vmorgTag:vmorg type="json" hasBlank="false" userId='' />}
        </c:if>
		],
		//定义form 表单 按钮信息
		buttons:[
	...
	var tableStructure = {
		...
		url : "${basePath}lbTCustServiceAuto/queryListSysUser"+uriParam,
